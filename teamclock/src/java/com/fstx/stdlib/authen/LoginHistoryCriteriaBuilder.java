...
public class LoginHistoryCriteriaBuilder implements CriteriaDecorator {
    ...
    public void decorateCriteria(Criteria criteria,
        ...
        if (!(parameters instanceof LoginHistoryFilterParameters)) {
            throw new CriteriaBuilderException("parameters are not LoginHistoryFilterParameters");
        }
