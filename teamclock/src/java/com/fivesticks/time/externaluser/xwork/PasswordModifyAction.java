...
import com.fivesticks.time.useradmin.xwork.PasswordModifyContext;
import com.fivesticks.time.useradmin.xwork.PasswordModifyContextAware;
import com.fivesticks.time.useradmin.xwork.UserModifyContext;
import com.fivesticks.time.useradmin.xwork.UserModifyContextAware;
 ...
 * @author Reid
 */
public class PasswordModifyAction extends AbstractExternalCustomerAction implements
         PasswordModifyContextAware, UserModifyContextAware {
