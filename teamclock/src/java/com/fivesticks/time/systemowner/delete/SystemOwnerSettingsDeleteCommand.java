 ...
 * @author Nick
 */
public class SystemOwnerSettingsDeleteCommand implements FstxCommand {
    ...
    public void execute() throws Exception {
         ...
         */
        SystemSettingsParameters filter = new SystemSettingsParameters();

        filter.setOwnerKey(so.getKey());

        SystemSettingsDao dao = SystemSettingsDaoFactory.factory.build();

        List elements = dao.find(filter);
