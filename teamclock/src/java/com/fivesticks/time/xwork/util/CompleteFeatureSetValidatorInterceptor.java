 ...
 *  
 */
public class CompleteFeatureSetValidatorInterceptor implements Interceptor {

    private Log log = LogFactory
            .getLog(CompleteFeatureSetValidatorInterceptor.class);
    ...
    public String intercept(ActionInvocation arg0) throws Exception {
        ...
        if (sc.getSettings().getFeatureSet() != SettingFeatureSetTypeEnum.SUPERUSER
                && sc.getSettings().getFeatureSet() != SettingFeatureSetTypeEnum.COMPLETE) {
            log.info("current session context is invalid.");
            return "global-login"; //global login page.
        }
