 ...
 *  
 */
public class UserRoleExternalInterceptor implements Interceptor {

//    private Log log = LogFactory.getLog(UserRoleExternalInterceptor.class);
    ...
    public String intercept(ActionInvocation arg0) throws Exception {
        ...
        if (sc.getUserTypeEnum() != UserTypeEnum.EXTERNAL) {
            return GlobalForwardStatics.GLOBAL_DASHBOARD; //global login page.
        }
