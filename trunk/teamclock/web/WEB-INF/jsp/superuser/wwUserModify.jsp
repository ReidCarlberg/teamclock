...
<p><a href="<webwork:url value="'ownerPasswordModify.action'"><webwork:param name="'targetUser'" value="userModifyContext.target.user.username" /></webwork:url>">Change Password</a>

<p>&nbsp;

<webwork:form action="'ownerUserModify.action'" method="'post'">
